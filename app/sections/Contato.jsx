          ...
          <div className="reveal" style={{ display: 'flex', flexDirection: 'column', gap: '36px' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <a href="https://instagram.com/obahginkeria" target="_blank" style={{ fontSize: '16px', fontWeight: 300, color: '#2E2B26', textDecoration: 'none' }}>@obahginkeria</a>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                {['Mesas externas', 'Ótimos coquetéis', 'Música ao vivo'].map(item => (
                  <span key={item} style={{ fontSize: '12px', letterSpacing: '0.1em', textTransform: 'uppercase', color: '#C8841A', border: '1px solid #F5A623', padding: '6px 14px', borderRadius: '1px' }}>{item}</span>
                ))}
              </div>
            </div>
          </div>
