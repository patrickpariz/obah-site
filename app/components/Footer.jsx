export default function Footer() {
  return (
    <>
      ...
      {/* WhatsApp flutuante */}
      <a href="https://wa.me/5521993753021" target="_blank" style={{ position: 'fixed', bottom: '28px', right: '28px', zIndex: 99, width: '52px', height: '52px', background: '#25D366', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 20px rgba(37,211,102,0.35)', textDecoration: 'none' }}>
